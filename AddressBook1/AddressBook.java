...
public class AddressBook extends JFrame {
   ...
   public static void main( String args[] )
   {
      SwingUtilities.invokeLater(new Runnable() {
         ...
         public void run() {
            try {
               String lnfDesign = "com.sun.java.swing.plaf.windows.WindowsLookAndFeel";
   ...
   private class NewAction extends AbstractAction {
      ...
      public NewAction()
      {
         ...
         putValue( SMALL_ICON, new ImageIcon(
                 getClass().getResource( "icons/New24.png" ) ) );
   ...
   private class SaveAction extends AbstractAction {
      ...
      public SaveAction()
      {
         putValue( NAME, "Save" );
         putValue( SMALL_ICON, new ImageIcon(
                 getClass().getResource( "icons/Save24.png" ) ) );
   ...
   private class DeleteAction extends AbstractAction {
      ...
      public DeleteAction()
      {
         ...
         putValue( SMALL_ICON, new ImageIcon(
                 getClass().getResource( "icons/Delete24.png" ) ) );
   ...
   private class SearchAction extends AbstractAction {
      ...
      public SearchAction()
      {
         ...
         putValue( SMALL_ICON, new ImageIcon(
                 getClass().getResource( "icons/Find24.png" ) ) );
